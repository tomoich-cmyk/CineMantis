...
SET wikidata_entity_id = CASE
  ...
  WHEN award_body_id = (SELECT id FROM award_bodies WHERE name = 'BAFTA Film Awards') AND name = 'Best Film' THEN 'Q637537'
  WHEN award_body_id = (SELECT id FROM award_bodies WHERE name = 'Cesar Awards') AND name = 'Best Film' THEN 'Q634158'
  WHEN award_body_id = (SELECT id FROM award_bodies WHERE name = 'Goya Awards') AND name = 'Best Film' THEN 'Q1418426'
  ...
  WHEN award_body_id = (SELECT id FROM award_bodies WHERE name = 'Sundance Film Festival') AND name = 'Grand Jury Prize: U.S. Dramatic' THEN 'Q1023898'
  ...
  WHEN award_body_id = (SELECT id FROM award_bodies WHERE name = 'European Film Awards') AND name = 'European Film' THEN 'Q7051897'
